          ...
          <div class="card_items col-12 col-sm-6 col-md-4 col-lg-3 mb-4 px-2 " v-for="item, index in slicedItems" :key="index" >              
                <div class="card " style="background-color: transparent;" >
                  <div class="badge bg-warning position-absolute fav" style="">
                      ...
                      <div v-if="!item.stock > 0" class="badge bg-danger text-white position-absolute out" style="">Sold</div>
            ...
            <div class="d-flex justify-content-center" style="background-color: #00001A;">
              <div class="d-flex flex-column align-items-center" >
                    ...
                    <ul v-if="selectedItem">
                      ...
                      <li class="text-white"><font-awesome-icon icon="thumbs-up" /><strong class="text-white"> Ratings: {{selectedItem.rating}}/5</strong>
